     ...
     > 
        ...
        //this is what we want the PlacesAutocomplete to render i.e. this is the render function.     
            <Form.Field error={touched && !!error}>
                ...
                {/* spreading getInputProps which we get from PlacesAutoComplete, into our input field element. We can specify which input props we want to be shown on the input element.  */}
