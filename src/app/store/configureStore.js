...
const rrfConfig = { //giving react redux firestore some configuration.  
    ...
    attachAuthIsReady: true, //this allows us to wait until the authentication is ready before we go and render something in our app. We use this in our index.js file.
