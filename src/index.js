...
store.firebaseAuthIsReady.then(() => { //only render once our firebase auth is ready. Otherwise we'll see things try to render before we have our necessary information 
    render();
})
